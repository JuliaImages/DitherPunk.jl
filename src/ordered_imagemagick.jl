...
"""
IM_checks(; kwargs...) = OrderedDither(CHECKS; max=3, kwargs...)
const CHECKS = [
    1 2
    2 1
]
...
"""
IM_h4x4a(; kwargs...) = OrderedDither(H4X4A; max=9, kwargs...)
const H4X4A = [
    4 2 7 5
    3 1 8 6
    7 5 4 2
...
"""
IM_h6x6a(; kwargs...) = OrderedDither(H6X6A; max=19, kwargs...)
const H6X6A = [
    14 13 10  8  2  3
    16 18 12  7  1  4
    15 17 11  9  6  5
...
"""
IM_h8x8a(; kwargs...) = OrderedDither(H8X8A; max=33, kwargs...)
const H8X8A = [
